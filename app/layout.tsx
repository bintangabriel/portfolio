...
export const metadata = {
  title: 'Bintang Portfolio',
  description: 'Junior Software Engineer. Final Year Student at Computer Science Universitas Indonesia',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className='!scroll-smooth'>
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative h-[3900px] pt-28 sm:pt-25`}>
